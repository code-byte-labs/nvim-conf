...
vim.api.nvim_create_autocmd("ColorScheme", {
  ...
  callback = function()
    ...
    vim.api.nvim_set_hl(0, "@lsp.typemod.function.defaultLibrary.kotlin", { link = "@function" })
    vim.api.nvim_set_hl(0, "@lsp.typemod.variable.modification.kotlin", { fg = colors.fg })
    vim.api.nvim_set_hl(0, "@lsp.typemod.function.declaration.kotlin", { link = "@function" })
